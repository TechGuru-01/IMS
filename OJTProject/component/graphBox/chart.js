document.addEventListener("DOMContentLoaded", function () {
  ...
  if (isMonthly) {
    ...
    container.style.cssText =
      "background: #fff; padding: 20px; border-radius: 8px; border: 1px solid #eee; height: 500px; width: 100%; margin-bottom: 20px;";
    ...
    new Chart(document.getElementById("mainMonthlyChart"), {
      ...
      options: {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: `Usage for ${now.toLocaleString("default", { month: "long" })} ${year}`,
          },
        },
        scales: {
          x: {
