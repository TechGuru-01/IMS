<?php
// 1. GET CURRENCY RATES FROM SETTINGS
$usd_rate = 1; 
$jpy_rate = 1;
...
// DAPAT GANITO ANG PAGKAKA-AYOS:
date_default_timezone_set('Asia/Manila'); // Siguraduhin na Manila time
...
// date('Ymd') ang kukuha ng 20260318 base sa NOW() mo kanina
...
<div id="prModal" class="modal-overlay">
    <div style="background:white; padding:25px; border-radius:12px; width:98%; max-width:1100px; box-shadow:0 10px 25px rgba(0,0,0,0.2); overflow-y:auto; max-height:95vh;">
