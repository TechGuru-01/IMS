...
// --- 1. SESSION FIX (Default to Last Selected) ---
if (isset($_GET['month'])) {
...
$cols = ['id', 'category', 'cabinet', 'item', 'description', 'beginning_inventory', 'received_qty', 'quantity', 'min_quantity', 'price', 'is_acknowledged'];
...
if (isset($_POST['addItem'])){
    ...
    // --- UUID LOOKUP: Naghahanap ng kaparehas na UUID sa kahit anong buwan ---
    ...
    // Kung may nahanap, gamitin. Kung wala (bago), generate ng unique ID.
    ...
    $stmt = $conn->prepare("INSERT INTO inventory 
        ...
        ON DUPLICATE KEY UPDATE 
            ...
            -- FIX: Pinipilit lagyan ng laman kung NULL ang existing record
...
if (isset($json['updateData'])){
    foreach($json['updateData'] as $row){
        ...
        foreach($row as $key => $val){
            ...
            // PROTECTED: Hindi pwedeng i-edit ang item_uuid via UI
